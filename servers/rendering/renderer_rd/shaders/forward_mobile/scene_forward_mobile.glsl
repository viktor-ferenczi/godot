...
#undef BIAS_FUNC
		...
		for (uint i = 0; i < 8; i++) {
			...
			light_compute(normal, directional_lights.data[i].direction, view, 0.0, directional_lights.data[i].color * directional_lights.data[i].energy, shadow, f0, orms, 1.0, albedo, alpha,
